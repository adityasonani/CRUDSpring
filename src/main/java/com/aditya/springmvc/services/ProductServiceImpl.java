...
public class ProductServiceImpl implements ProductService {
	...
	private void loadProducts() {
		...
		product2.setImageUrl("http://example.com/product1");
		...
		product3.setImageUrl("http://example.com/product1");

		products.put(3, product3);

		Product product4 = new Product();
		product4.setId(4);
		product4.setDescription("this is product 4");
		product4.setPrice(new BigDecimal("12"));
		product4.setImageUrl("http://example.com/product1");

		products.put(4, product4);

		Product product5 = new Product();
		product5.setId(5);
		product5.setDescription("this is product 5");
		product5.setPrice(new BigDecimal("12.99"));
		product5.setImageUrl("http://example.com/product1");
